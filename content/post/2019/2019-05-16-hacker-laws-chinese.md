...
![阿姆达尔定律](/images/2019/amdahls_law.png)
...
![The Hype Cycle](/images/2019/gartner_hype_cycle.png)
...
这些结论表明，由于各种选择标准和群体组织的趋势，技术组织的工作层面将有一些技术人员，以及一些不了解复杂性和挑战的管理人员。 这种现象可能是由于 [The Peter Principe](#TODO) 或者 [Dilbert's Law](#TODO) 造成的。
...
该项目尚未编写完成，最新进展请查看 [https://github.com/nusr/hacker-laws-zh](https://github.com/nusr/hacker-laws-zh)
